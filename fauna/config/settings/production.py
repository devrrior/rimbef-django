...
environ.Env.read_env(os.path.join(ROOT_DIR, ".env.production"))

SECRET_KEY = env.str("DJANGO_SECRET_KEY", "ejALLPRKfzKr4imU5wUYpfyee0DZyt3T")
...
CORS_ALLOWED_ORIGINS = [
    # Add domain name or IP where the frontend is running
]
